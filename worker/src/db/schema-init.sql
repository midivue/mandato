-- Safe schema initialization — uses CREATE TABLE IF NOT EXISTS.
-- Can be run against any D1 database (including production) without data loss.
...
CREATE INDEX IF NOT EXISTS idx_predictions_visibility ON predictions(visibility);
