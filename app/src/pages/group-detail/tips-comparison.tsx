...
export function TipsComparison({ members, userShareToken }: TipsComparisonProps) {
          ...
          <tbody>
            {members.map((member) => {
              ...
              return (
                ...
                >
                  <td className="sticky left-0 bg-white px-1.5 py-2 font-medium text-zinc-900 whitespace-nowrap sm:px-3">
                    <a
